...
![Making your initial commit](images/02-basics/initial_commit.png){height="300px"}
...
![The History panel after our first commit](images/02-basics/history.png){height="500px"}
...
![Checking out an old commit to travel through time](images/02-basics/checkout.png){height="400px"}

---

![Trying (and failing) to change the past.  My current HEAD commit will disappear as soon as I check out main.](images/02-basics/changing_past.png){height="500px"}
...
:::: columns
::: {.column width=.7}
![Merging `fixing-mistake` into `main`](images/02-basics/merge.png){width="100%"}
:::
...
![Sourcetree's File status panel indicates which files have conflicts](images/02-basics/conflicts.png){height="500px"}
...
![The History panel shows the branches merging back together](images/02-basics/post_merge.png){height="500px"}
...
![The remote `origin` lives on GitHub. Source: <https://happygitwithr.com/common-remote-setups.html#ours-you>](https://happygitwithr.com/img/ours-them.jpeg){height="500px"}
...
::: column 
![Adding a new remote](images/02-basics/origin.png){width="500px"}
:::
::::
...
![*Forking* copies a repository to your GitHub account.  Then you *clone* the copy to your local machine.  You can *push* to your remote copy as usual.  You can suggest changes to the original using a *pull request*.  Source: <https://happygitwithr.com/fork-and-clone.html>](images/02-basics/fork-and-clone.png){height="500px"}
