...
%%| echo: false
%%| fig-height: 5
%%| fig-cap: "Representing a board game for object-oriented programming.  Each class of objects has its own properties and functions, and instances of these classes will interact with each other as the program runs."
classDiagram
   class Game{
      players: Player
      board: Board
...
```{mermaid}
%%| echo: false
%%| fig-cap: "A regression model as an OOP object, showing how different attributes and methods work together."
flowchart LR
...
## Common features of functional programming {.smaller}
...
## Functional R:  Pipes (and the tidyverse)
