...
```{r, echo = FALSE, fig.cap = "Tweet by Nathan Oseroff-Spicer (\\@nathanoseroff): 'It makes sense, though, since there are rows and columns. It's scientific'. Source: <https://twitter.com/nathanoseroff/status/1321565407568867332>"}
