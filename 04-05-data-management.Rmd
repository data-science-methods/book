...
```{r, echo = FALSE, out.width = '80%', fig.cap = "Example of Caitlyn Hudon's approach to building a data dictionary. Source: <https://caitlinhudon.com/2018/10/30/data-dictionaries/>"}
