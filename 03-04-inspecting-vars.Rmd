...
- For this EDA, we'll work with data on police stops in Oakland, California, that have been pre-cleaned and released by the [Stanford Open Policing Project](https://openpolicing.stanford.edu/).  
    - *[cite paper]*
...
- These are rough questions, but are enough to get us started
