...
```{r, echo = FALSE, fig.cap = '`matplotlib`, a popular Python package for graphing, uses the artist\'s palette model.  Source: <https://matplotlib.org/stable/gallery/subplots_axes_and_figures/subplot.html>', out.width='30%', fig.show='hold', fig.align='center'}
