...
```{r, echo = FALSE, out.width = '80%', fig.cap = "😱 Source: <https://pbs.twimg.com/media/DFca5SRXsAAx1NA>"}
knitr::include_graphics('https://pbs.twimg.com/media/DFca5SRXsAAx1NA?format=jpg&name=medium')
```
...
```{r, echo = FALSE, out.width = '60%', fig.cap = "Folder organization is your friend. I have top-level folders for teaching, coding, and writing projects. Then each project or collection of projects lives in its own folder. An 'Archives' folder is good for tucking old projects out of the way."}
knitr::include_graphics(file.path('images', '04-reproducibility', 'folder_structure.png'))
```
...
knitr::include_graphics(file.path('images', '04-reproducibility', 'noble.png'))
```
...
Published paper: <https://direct.mit.edu/qss/article/doi/10.1162/qss_a_00150/106952/Productivity-and-interdisciplinary-impacts-of>\
